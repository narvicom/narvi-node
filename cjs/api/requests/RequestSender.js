...
const PlatformFunctions_1 = require("../../platform/PlatformFunctions");
...
class RequestSender {
        ...
        return (res) => {
            ...
            res
                ...
                if (jsonResponse.error) {
                    ...
                    if (statusCode === 401) {
                        err = new Errors_1.NarviAuthenticationError(jsonResponse.error);
                    }
                    else if (statusCode === 403) {
                        err = new Errors_1.NarviPermissionError(jsonResponse.error);
                    }
                    else if (statusCode === 429) {
                        err = new Errors_1.NarviRateLimitError(jsonResponse.error);
                    }
                    else {
                        err = Errors_1.NarviError.generate(jsonResponse.error);
                    }
                    throw err;
                }
                return jsonResponse;
            }, (e) => {
                throw new Errors_1.NarviAPIError({
    ...
    _defaultIdempotencyKey(method, settings) {
        ...
        if (method === 'POST' && maxRetries > 0) {
            return `narvi-node-retry-${(0, PlatformFunctions_1.uuid4)()}`;
        }
        return null;
    }
    ...
    options = {}, callback, requestDataProcessor = null) {
        ...
        const makeRequest = (apiVersion, headers, numRetries) => {
            ...
            req
                ...
                if (RequestSender._shouldRetry(null, requestRetries, maxRetries, error)) {
                    ...
                    return callback(new Errors_1.NarviConnectionError({
        ...
        if (requestDataProcessor) {
            ...
            prepareAndMakeRequest(null, (0, utils_1.stringifyRequestData)(data || {}, methodHasPayload));
        }
    }
}
